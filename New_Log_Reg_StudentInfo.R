...
data <- read.csv("/Users/indiramallela/Dropbox/Northwood/ML/ML course data download week1/studentInfo.csv") # Replace "your_dataset.csv" with the path to your dataset
